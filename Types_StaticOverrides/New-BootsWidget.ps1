...
PROCESS {
   ...
   #  if($Handle = Select-Window -Text "Posh Gadget" -class "BasicWindow" | Select -First 1 -Expand Handle) {
      #  $PSBoundParameters["Owner"] = $Handle
   #  }
   ...
   if($Window -and $Window.Handle ) { 
      ...
      #if($Handle = Select-Window -class "Progman" | Select -First 1 -Expand Handle) {
      #   [Huddled.Dwm]::SetParent( $Window.Handle, $Handle)
      #}
   }
...
[CmdletBinding()]
PARAM(
   [Parameter()][Alias("Name")][string]$Text="*",
   [Parameter()][string]$ClassName="*",
   [Parameter()][string]$ControlType="*",
	[Parameter()][switch]$Recurse,
   [Parameter(ValueFromPipeline=$true)][System.Windows.Automation.AutomationElement]$Parent = [System.Windows.Automation.AutomationElement]::RootElement
) 
PROCESS {
   $Search = "Children";
   ...
   $Parent.FindAll( $Search, [System.Windows.Automation.Condition]::TrueCondition ) | 
        Add-Member -Name Text            -Type ScriptProperty -PassThru -Value {
                  $this.GetCurrentPropertyValue([System.Windows.Automation.AutomationElementIdentifiers]::NameProperty) 
    } | Add-Member -Name ClassName       -Type ScriptProperty -Passthru -Value { 
                  $this.GetCurrentPropertyValue([System.Windows.Automation.AutomationElementIdentifiers]::ClassNameProperty) 
    } | Add-Member -Name ProcessId       -Type ScriptProperty -Passthru -Value { 
                  $this.GetCurrentPropertyValue([System.Windows.Automation.AutomationElementIdentifiers]::ProcessIdProperty) 
    } | Add-Member -Name Handle          -Type ScriptProperty -Passthru -Value { 
                  $this.GetCurrentPropertyValue([System.Windows.Automation.AutomationElement]::NativeWindowHandleProperty) 
    } | Add-Member -Name ControlType     -Type ScriptProperty -Passthru -Value { 
                  $this.GetCurrentPropertyValue([System.Windows.Automation.AutomationElementIdentifiers]::LocalizedControlTypeProperty) 
    } | Where-Object {
...
$null = [Reflection.Assembly]::Load("UIAutomationClient, Version=3.0.0.0, Culture=neutral, PublicKeyToken=31bf3856ad364e35")
}
}
}
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUdsQuxbK5B18LazSmmHIWU0wj
# 6KWggg5CMIIHBjCCBO6gAwIBAgIBFTANBgkqhkiG9w0BAQUFADB9MQswCQYDVQQG
...
# AQQBgjcCAQsxDjAMBgorBgEEAYI3AgEWMCMGCSqGSIb3DQEJBDEWBBTCX5RcXf0L
# PPrNTiqqsLzOhqhw/TANBgkqhkiG9w0BAQEFAASCAQClaHmsYxm/NmElvODcsO5O
# oUabRT29dgY27Hn1i8Golt5z6YJjHFN4U2SbtJwKBq9jPOzhLdhzqP4SBvuPYG57
# h/5JaxhJfPygnBRQj1Wwq/t36qF7Aw7qrrS5Lnv6I+V8+R+40QI17v61IiW7DG0z
# hkUhrCom/oCFjEPCBbPyLJz2rXFP5pDZZego19a8xhqRZcy2MwkBwcq+DssuzDk3
# gbwOuEZwJWlkL912RR/wk4UULgAOxdEyIHaJ6uXRGblfVYb1lmgeBp7gHVb0hj6H
# xTx/h+uFeysDqGfz+is8tRqs+n7dTLDKLbcryGjyA9eu/b8UqekhhLBq5U/2YJnQ
